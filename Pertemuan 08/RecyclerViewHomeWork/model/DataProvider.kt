...
class DataProvider {
    ...
    companion object {
        ...
        init {
            var name = "Walnut Banana Bread Pudding";
            var description = "My mom has been making this recipe since I was little. " +
            ...
            var image = "https://images.media-allrecipes.com/userphotos/250x250/829687.jpg";
            var ingredients = "1/2 cup butter, divided\n" +
            ...
            recipes.add(Recipe(name, description, image, ingredients, directions))
            ...
            image =
                "https://assets.epicurious.com/photos/54b28e8aa801766f773f9ebf/6:4/w_620%2Ch_413/368689_bourbon-bread-pudding_1x1.jpg"
